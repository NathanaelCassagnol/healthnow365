...
// https://hl7.org/fhir/R4/medicationdispense0308.json.html
// Dispense for Timoptic Opthalmic Drops - (NDC code) - completed

export const mockMedicationDispense9: MedicationDispense = {
