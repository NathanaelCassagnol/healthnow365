...
// https://hl7.org/fhir/R4/medicationdispense0310.json.html
// Dispense for Percocet (NDC Code) - in-progress with additionalInstructions, and as needed dosage with condition

export const mockMedicationDispense11: MedicationDispense = {
