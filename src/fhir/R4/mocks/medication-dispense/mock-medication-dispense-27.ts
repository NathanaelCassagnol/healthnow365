...
// https://hl7.org/fhir/R4/medicationdispense0327.json.html
// Dispense for Proventil (RxNorm Code) - completed - with additionalInstructions as text

export const mockMedicationDispense27: MedicationDispense = {
      ...
      "coding": [
        {
          ...
          "code": "746763",
          "display": "Proventil 0.09mg/actuat (Albuterol sulfate 0.108mg/actuat from mouthpiece)"
        }
      ]
    },
    "subject": {
