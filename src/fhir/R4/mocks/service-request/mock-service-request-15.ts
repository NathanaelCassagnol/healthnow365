...
// https://hl7.org/fhir/R4/servicerequest-example-pt.json.html
// Example of an order for an physical therapy evaluation procedure

export const mockServiceRequest15: ServiceRequest = {
