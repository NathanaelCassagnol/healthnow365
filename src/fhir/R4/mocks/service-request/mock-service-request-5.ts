...
// https://hl7.org/fhir/R4/servicerequest-example-subrequest.json.html
// Example with sub-requests derived from the request

export const mockServiceRequest5: ServiceRequest = {
