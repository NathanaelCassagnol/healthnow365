import { ClinicalImpression } from "../../types/clinical-impression";

// https://hl7.org/fhir/R4/clinicalimpression-example.json.html
// Example of clinicalimpression

export const mockClinicalImpression1: ClinicalImpression = {
