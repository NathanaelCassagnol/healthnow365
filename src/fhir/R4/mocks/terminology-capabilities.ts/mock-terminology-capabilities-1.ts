import { TerminologyCapabilities } from "fhir/R4/types/terminology-capabilities";

// https://hl7.org/fhir/R4/terminologycapabilities-example.json.html
// General Condition Example

export const mockTerminologyCapabilities1: TerminologyCapabilities = {
