...
// https://hl7.org/fhir/R4/medicationexample0318.json.html
// Compounded Preparation - TPN Solution - includes a reference to a substance in the ingredient element

export const mockMedicationCompounded2: Medication = {
