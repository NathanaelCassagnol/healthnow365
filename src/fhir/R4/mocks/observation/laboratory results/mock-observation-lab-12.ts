...
// https://hl7.org/fhir/R4/observation-example-bloodgroup.json.html
// An example of a blood group (ABO) measurement.

export const mockObservationLab12: Observation = {
