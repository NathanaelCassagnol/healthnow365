...
// https://hl7.org/fhir/R4/observation-example-date-lastmp.json.html
// An "ask at order" response using the datetime datetype for the result value

export const mockObservationLab10: Observation = {
