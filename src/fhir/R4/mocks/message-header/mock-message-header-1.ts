import { MessageHeader } from "fhir/R4/types/message-header";

// https://hl7.org/fhir/R4/messageheader-example.json.html
// A typical message header

export const mockMessageHeader1: MessageHeader = {
