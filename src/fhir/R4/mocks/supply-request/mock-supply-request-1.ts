import { SupplyRequest } from "fhir/R4/types/supply-request";

// https://hl7.org/fhir/R4/supplyrequest-example-simpleorder.json.html
// Simple order for resupply

export const mockSupplyRequest1: SupplyRequest = {
