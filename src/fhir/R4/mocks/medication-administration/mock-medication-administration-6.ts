...
// https://hl7.org/fhir/R4/medicationadministration0305.json.html
// Intravenous Chemotherapy (Inpatient order) - Brentuximab Vedotin

export const mockMedicationAdministration6: MedicationAdministration = {
