...
// https://hl7.org/fhir/R4/list-example-familyhistory-genetics-profile-annie.json.html
// Example for risk assessment

export const mockList7: List = {
    "resourceType": "List",
    "id": "prognosis",
    "text": {
      "status": "generated",
    ...
    "contained": [
      ...
      },
      {
        ...
        "patient": {
          ...
          "display": "Annie Proband, female, born 1966"
        },
        "name": "Annie",
        "relationship": {
          "coding": [
              ...
              "coding": [
                {
                  "system": "urn:oid:2.16.840.1.113883.3.26.1.1",
                  "code": "C2924",
                  "display": "Ductal Carcinoma In Situ of the Breast"
                }
              ]
            },
            "onsetAge": {
        ...
        "condition": [
          {
            "code": {
              "coding": [
                ...
                {
                  "system": "urn:oid:2.16.840.1.113883.6.133",
                  "code": "1101",
                  "display": "BRCA2"
                }
              ],
              "text": "BRCA2 breast cancer 2, early onset"
            }
          }
        ]
      },
