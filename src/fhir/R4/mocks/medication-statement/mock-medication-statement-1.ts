...
// https://hl7.org/fhir/R4/medicationstatementexample1.json.html
// Patient reports they are taking Tylenol PM and has the bottle

export const mockMedicationStatement1: MedicationStatement = {
