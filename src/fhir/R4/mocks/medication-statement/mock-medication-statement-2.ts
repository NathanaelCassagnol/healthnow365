...
// https://hl7.org/fhir/R4/medicationstatementexample2.json.html
// Patient reports they are not taking Tylenol PM

export const mockMedicationStatement2: MedicationStatement = {
