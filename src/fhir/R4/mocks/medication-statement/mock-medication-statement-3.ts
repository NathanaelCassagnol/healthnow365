...
// https://hl7.org/fhir/R4/medicationstatementexample4.json.html
// Patient reports they were taking Amoxycillin in the past but are not taking it now

export const mockMedicationStatement3: MedicationStatement = {
