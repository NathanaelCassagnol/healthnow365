...
// https://hl7.org/fhir/R4/medicationrequest0334.json.html
// Request for a medication that is intended to be given on a specific day

export const mockMedicationRequest35: MedicationRequest = {
