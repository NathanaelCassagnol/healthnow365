...
// https://hl7.org/fhir/R4/medicationrequest0335.json.html
// Request for a medication that is intended to be given at a specific time

export const mockMedicationRequest36: MedicationRequest = {
