...
// https://hl7.org/fhir/R4/medicationrequest0325.json.html
// Request using Medication Code for Topical Ointment - Nystatin - on hold and with dispense request

export const mockMedicationRequest26: MedicationRequest = {
