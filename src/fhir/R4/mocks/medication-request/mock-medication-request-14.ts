...
// https://hl7.org/fhir/R4/medicationrequest0313.json.html
// Request with a single dosage line - Azithromycin - completed - with link to prior prescription and reason code

export const mockMedicationRequest14: MedicationRequest = {
