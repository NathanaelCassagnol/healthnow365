...
// https://hl7.org/fhir/R4/medicationrequest0327.json.html
// Request using Medication Code for Patch - Fentanyl - active, with dispense request

export const mockMedicationRequest28: MedicationRequest = {
