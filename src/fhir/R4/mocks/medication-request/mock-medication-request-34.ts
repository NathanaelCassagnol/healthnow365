...
// https://hl7.org/fhir/R4/medicationrequest0333.json.html
// Request for a medication that is intended to be given in the morning

export const mockMedicationRequest34: MedicationRequest = {
