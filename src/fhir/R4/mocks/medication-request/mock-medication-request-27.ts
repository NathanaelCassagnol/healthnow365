...
// https://hl7.org/fhir/R4/medicationrequest0326.json.html
// Request using Medication Code for Inhaler - Proventil - on hold with dispenseRequest and substitution

export const mockMedicationRequest27: MedicationRequest = {
