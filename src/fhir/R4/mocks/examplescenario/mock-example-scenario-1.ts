import { ExampleScenario } from "fhir/R4/types/example-scenario";

// https://hl7.org/fhir/R4/examplescenario-example.json.html
// Example of examplescenario

export const mockExampleScenario1: ExampleScenario = {
