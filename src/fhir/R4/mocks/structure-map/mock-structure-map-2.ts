import { StructureMap } from "fhir/R4/types/structure-map";

// https://hl7.org/fhir/R4/structuremap-supplyrequest-transform.json.html
// Transforms an ActivityDefinition to a SupplyRequest

export const mockStructureMap2: StructureMap = {
